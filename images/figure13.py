...
result_name=["../demos/viper_real_slope/outputs/GRC3/Earth/omega0.8/soil", 
             "../demos/viper_real_slope/outputs/GRC3/Earth/omega0.8/soil", 
             "../demos/viper_real_slope/outputs/GRC3/Earth/omega0.8/soil", 
             "../demos/viper_real_slope/outputs/GRC3/Moon/omega0.8/soil", 
             "../demos/viper_real_slope/outputs/GRC3/Moon/omega0.8/soil", 
             "../demos/viper_real_slope/outputs/GRC3/Moon/omega0.8/soil"]
line_label=[r'Earth, $\varphi=37.8, \rho=1627$',
            r'Earth, $\varphi=42.0, \rho=1734$',
            r'Earth, $\varphi=47.8, \rho=1839$',
            r'Moon, $\varphi=37.8, \rho=1627$',
            r'Moon, $\varphi=42.0, \rho=1734$',
            r'Moon, $\varphi=47.8, \rho=1839$']
title_name='FullRover, Earth/Moon Vs. Experiments, GRC3'
fig_name = "figure/figure13.png"
