...
void ViperPart::CalcMassProperties(double density) {
    ...
    m_mass = density * vol * 5.0;
    m_inertia *= density * 5.0;
...
ViperWheel::ViperWheel(const std::string& name,
    ...
    CalcMassProperties(15.5/0.0138);
}
