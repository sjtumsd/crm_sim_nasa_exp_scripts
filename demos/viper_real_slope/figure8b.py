...
line_label=[]
title_name=r'Full VIPER Rover, Moon, m=88kg, $\omega=0.33$rad/s, GRC-1'
...
# our results
for i in range(7):
    file=open("outputs/GRC1/Moon/omega0.33/soil3" + "_slope" + str(i*5) + "deg" + "/body_position.txt","r")
    Time=[]
    vel=[]
    num=0
    for line in file:
...
plt.savefig("88kg_Moon_angvel0_33_vel_GRC1.png", dpi=300)
