...
result_name=["single_wheel_real_slope_mode/outputs/GRC1/Moon/omega0.33/soil", 
             "single_wheel_real_slope_mode/outputs/GRC1/Moon/omega0.33/soil", 
             "single_wheel_real_slope_mode/outputs/GRC1/Moon/omega0.33/soil",
             "viper_real_slope/outputs/GRC1/Moon/omega0.33/soil",
             "viper_real_slope/outputs/GRC1/Moon/omega0.33/soil",
             "viper_real_slope/outputs/GRC1/Moon/omega0.33/soil"]
line_label=[r'Wheel, $\varphi=33.4,\rho=1660$', 
            r'Wheel, $\varphi=37.2,\rho=1730$', 
            r'Wheel, $\varphi=38.4,\rho=1760$',
            r'Rover, $\varphi=33.4,\rho=1660$', 
            r'Rover, $\varphi=37.2,\rho=1730$', 
            r'Rover, $\varphi=38.4,\rho=1760$']
title_name="Single Wheel Vs Full VIPER Rover, GRC1"
fig_name="Single_Wheel_22kg_Vs_Full_Rover_88kg_GRC1_Moon_Omega0_33.png"
...
l1=plt.legend([p2,p3],["MGRU3 2021 SLOPElab Tests, GRC1","MGRU3 2022 SLOPElab Tests, GRC1"],
    loc='lower right',fontsize=14)
# l1=plt.legend([p1],["TREC Nominal Tests, GRC3"], loc='lower right',fontsize=14)

angW = [0.33, 0.33, 0.33, 0.33, 0.33, 0.33]
i_range = [7,7,7,7,7,7]
for k in range(3):
    slip=[]
    slope=[]
    for i in range(i_range[k]):
        file=open(result_name[k] + str(k+1) + "_slope" + str(i*5) + "deg" + "/results.txt","r")
        Time=[]
        vel=[]
        num=0
        for line in file:
        ...
        slip.append(1 - sumsum/numnum/angW[k]/0.25)
        slope.append(i*5.0)
...
for k in range(3):
    ...
    slope=[]
    for i in range(i_range[k]):
        file=open(result_name[k] + str(k-2) + "_slope" + str(i*5) + "deg" + "/body_position.txt","r")
        Time=[]
        vel=[]
        num=0
        for line in file:
